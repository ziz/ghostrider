...
import { ghostAverageValue } from "../value";
...
function candyFactoryValue(): number {
  return (_candyFactoryValue ??= ghostAverageValue(...TRAIN_CANDIES));
}
...
const GOOD_TRAIN_STATIONS = [
  { piece: TrainSet.Station.GAIN_MEAT, value: () => 900 },
  {
    ...
    value: () => ghostAverageValue(...$items`bowl of cottage cheese, hot buttered roll, toast`),
  },
